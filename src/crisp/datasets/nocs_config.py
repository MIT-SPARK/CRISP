...
class Config(object):
    ...
    USE_RPN_ROIS = True
    RESNET = "resnet101"
    ROOT_DIR = "/home/hengyu/harry"
    OBJ_MODEL_DIR = os.path.join(ROOT_DIR, "obj_models")
    ...
    def __init__(self):
        ...
        self.BACKBONE_SHAPES = np.array(
            [
                [int(math.ceil(self.IMAGE_SHAPE[0] / stride)), int(math.ceil(self.IMAGE_SHAPE[1] / stride))]

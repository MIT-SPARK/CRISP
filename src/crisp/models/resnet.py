...
class ResNet(nn.Module):
    def __init__(
        ...
        # stride=2 for the original ResNet
        ...
        # to prevent output being (2048, 1, 1) which has size of 2048 < 2560
        self.avgpool = nn.AdaptiveAvgPool2d((2, 2))
        # use to be 512 * block.expansion (changed due to avgpool change)

...
EXTRAPOLATE_OBJ_1 = "obj_000015"
EXTRAPOLATE_OBJ_2 = "obj_000016"


class TestMode(Enum):
    INTERPOLATE = 1
    EXTRAPOLATE = 2
    EXTRAPOLATE_BETWEEN_SPECIFIED_OBJS = 3
    SIMPLEX_SAMPLE = 4
...
def main(opt):
    ...
    TEST_MODE = TestMode.EXTRAPOLATE_BETWEEN_SPECIFIED_OBJS
    ...
    if TEST_MODE == TestMode.SIMPLEX_SAMPLE:
        ...
        if TEST_MODE == TestMode.EXTRAPOLATE_BETWEEN_SPECIFIED_OBJS:
            ...
            mesh_screenshot_names = [
                f"./exports/ycbv/{prefix}_{model_name}/{o1}_{o2}/{o1}_{o2}_alpha_{a}.png"
                for a in alphas
            ]
            ...
            for i, obj_name in tqdm(enumerate(all_obj_names[:-1]), total=len(all_obj_names) - 1):
                ...
                if TEST_MODE == TestMode.INTERPOLATE:
                    ...
                    interp_shp_codes, _ = extrapolate_shape_code(shp_code_1, shp_code_2, steps=20)
                    prefix = "extrapolate"
                else:
